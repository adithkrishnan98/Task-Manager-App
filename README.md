...
## Description :
A simple and fully responsive CRUD application built using ReactJS, Framer Motion for animations, Axios for fetching data from a fake server. Implemented features such as :
* Viewing added tasks
* Adding new tasks 
