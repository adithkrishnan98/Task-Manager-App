...
const store = configureStore({
  // A reducer is a pure function that takes in information about a current state and it also takes some action that we want to perform on the states and returns the new values of the state.
  reducer : {
    tasks : taskReducer,
    darkLightSwitch : darkModetoggle
  }
})
