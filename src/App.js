...
function App() {
  ...
  return (
      <div className="inner-container" style={{backgroundImage : !darkMode ? "radial-gradient(#FFE082, #ffcf3b)" : "radial-gradient(#14467D, #081D34)", borderColor : !darkMode ? "black" : "white"}}> 
        ...
        <div className="App">
            <motion.h1 initial={{opacity:0}} animate={{opacity:1}} transition={{duration:2}} style={{color : darkMode ? "white" : "black", textShadow : !darkMode ? "3px 3px 2px #D7A21F" : "4px 4px 1px black"}} >Task Manager</motion.h1>
