...
const Mytasks = ({tasks, isPending, error}) => {
            ...
            <div className="sort-by-container">
                ...
                {filterClick ? (
                    <motion.div className="expand-content">
                        <p onClick={() => !mostImportant ? setMostImportant(true) : setMostImportant(false) }>Priority (high - low) {mostImportant ? <TiTick/> : null}</p>
                        <p onClick={() => !leastImportant ? setLeastImportant(true) : setLeastImportant(false)}>Deadline (high - low) {leastImportant ? <TiTick/> : null}</p>
