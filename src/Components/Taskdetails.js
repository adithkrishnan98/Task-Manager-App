...
const Taskdetails = (props) => {
    ...
    return ( 
        <motion.div className="task-details" style={{borderColor : !darkMode ? "black" : "white", background : !darkMode ? "whitesmoke" : "#004C74", color : !darkMode ? "black" : "white", boxShadow : !darkMode ? "3px 6px 6px grey" : "3px 6px 6px white"}} initial={{y:"100vh"}} animate={{y:0}} transition={{duration : 0.5}} exit={{x:"-100vw"}}>
